...
sap.ui.define([
	...
	return BaseController.extend("Avelon.manualnotification.controller.CreateEntity", {
		...
		onSave: function () {
			...
			var mode = this.getView().getModel("viewModel").getData().mode;
			...
			else if (mode === "edit")
			{
				...
				var path = "/NotificationInfoSet('" + id + "')";
				
				//var oDataModel = new sap.ui.model.odata.v2.ODataModel("/AV7/sap/opu/odata/avelon/MANUALNOTIFICATION_SRV/");
				
				//var oDataa = this.getView().getModel().getData();
				
				var oDataa = this.getView().getModel("EditNotificationForm").getData();
			debugger;
			/*var oViewModel = this.getView().getModel(),
				sPath = oViewModel.getProperty("/ManualNotifId");
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("NotificationInfoSet", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("NotificationInfoSet", oData);
